...
d. Give an example of a Boolean ring with unity having 4 elements. For example $\ZZ_2 =\{0,1\}$ is a Boolean ring with 2 elements.
...
a. Give an example where $N(A) = A$ and an example where $A \subsetneq N(A)$.
